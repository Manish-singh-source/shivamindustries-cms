  <!-- Footer -->
  <footer id="footer" class="footer-default footer-style-2 radius-16 line">
      <div id="footer-body">
          <div class="container">
              <div class="row-footer">
                  <div class="footer-col-block s1">
                      <div class="footer-heading footer-heading-mobile text-xl fw-medium">
                          <img src="img/shivam-logo.png" alt="" width="280px">
                      </div>
                          ...
                          <div class="footer-contact">
                              <ul class="footer-info">
                                  <li class="item">
                                      ...
                                      <a target="_blank"
                                          href="https://maps.app.goo.gl/xVTqUoXgdsEj59HY9">
                                          <strong>Head Office Address :</strong> S-11, Arihant Vrindavan Soc,
                                          Kasturi Park, Navghar Road, Bhayander East– Mumbai-Maharashtra Pin-
                                          401105
                                      </a>
                                  </li>
                                  <li class="item">
                                      ...
                                      <a target="_blank"
                                          href="https://maps.app.goo.gl/B9cdCrUiDbMtsHUz7">
                                          <strong>Branch Office Address :</strong> No A-8, sector 22, GIDA,
                                  ...
                                  <li class="item">
                                      ...
                                      <a href="tel:+919820823043"> +91 9820 82 3043 </a>
                                  </li>
                                  <li class="item">
                                      <span class="box-icon">
                                          <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                      ...
                                      <a href="mailto:sales@shivaminds.com">sales@shivaminds.com</a>
                                  </li>
                                  <li class="item">
                                      <span class="box-icon">
                                          <svg width="14" height="14" viewBox="0 0 14 14" fill="none"
                                      ...
                                      <a href="mailto:chandan@shivaminds.com">chandan@shivaminds.com</a>
                                  </li>
                              </ul>
                  ...
                  <div class="footer-inner-wrap s2">
                      <div class="footer-heading footer-heading-mobile text-xl fw-medium">
                      ...
                      <div class="tf-collapse-content">
                          <div class="footer-newsletter">
                              <p>
                                  Shivam Industries, Mumbai are one of the leading manufacturer and distributors
                                  of a wide range of industrial chemicals, solvents, pharma cosmetics and foundry
                                  chemicals.
                                  Our effective distribution network makes the delivery within the stipulated time
                                  frame.
                              </p>
                              <!-- <form class="form-newsletter subscribe-form" accept-charset="utf-8" data-mailchimp="true">
                  ...
                  <div class="footer-inner-wrap s3">
                      <div class="footer-col-block inner-col">
                          <div class="footer-heading footer-heading-mobile text-xl fw-medium">Quick Link</div>
                          <div class="tf-collapse-content">
                      ...
                      <div class="footer-col-block inner-col">
                          ...
                          <div class="tf-collapse-content">
                              <ul class="footer-menu-list">
                                  <li>
                                      <a href="corporate-video.php">Corporate Video</a>
                                  </li>

                                  <li>
                                      <a href="quality-compliance.php">Quality & Compliance</a>
                                  </li>
                                  <li>
                                      <a href="product-portfolio.php">Product Portfolio</a>
                                  </li>
                                  <li>
                                      <a href="corporate-presentation.php">Corporate Presentation</a>
                                  </li>
                                  <li>
                                      <a href="pdf/shivam-industries-mumbai.pdf" target="_blank">Download Brochure</a>
                                  </li>
          ...
          <div class="footer-bottom">
              <div class="container">
                  <div class="footer-bottom-wrap">
                      <p class="text-dark">Copyright © 2025 by <a href="https://www.shivaminds.com/" target="_blank"> <span class="fw-medium">Shivam Industries.</span></a>
                          All
                          Rights
                          Reserved.</p>
                      <ul class="tf-payment">
                          <p class="text-dark">Designed by <a href="https://www.technofra.com/" target="_blank"> <span class="fw-medium">Technofra.</span></a> </p>
      ...
      <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
              ...
              <div class="mega-menu">
                  <div class="row-demo">
                      <div class="demo-item">
                          <a href="index.php" class="demo-image">
                          </a>
                      </div>
                  </div>
              </div>
      ...
      <div class="mb-canvas-content">
          <div class="mb-body">
              ...
              <div class="mb-other-content">
                  ...
                  <div class="mb-notice">
                      <a href="contact-us.php" class="text-need">Contact Us</a>
                  </div>
                  <div class="mb-contact">
                      <p>Address: S-11, Arihant Vrindavan Soc, Bhayander East – Mumbai-Maharashtra Pin-401105.</p>
                  </div>
                  <ul class="mb-info">
                      <li>
                          Email:
                          <b class="fw-medium">sales@shivaminds.com</b>
                      </li>
                      <li>
                          Phone:
                          <b class="fw-medium">+91 9820 82 3043</b>
                      </li>
                  </ul>
              </div>
          </div>
  ...
  <script>
      ...
      var AUTOHIDE = false; // Boolean(0) replaced with clean boolean
  </script>
